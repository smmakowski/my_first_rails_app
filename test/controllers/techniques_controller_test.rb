...
class TechniquesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create technique" do
    assert_difference('Technique.count') do
      post techniques_url, params: { technique: { gi: @technique.gi, name: @technique.name, position_id: @technique.position_id, top: @technique.top, type_id: @technique.type_id } }
    end
  ...
  test "should update technique" do
    patch technique_url(@technique), params: { technique: { gi: @technique.gi, name: @technique.name, position_id: @technique.position_id, top: @technique.top, type_id: @technique.type_id } }
